...
![set-locale-a04a0edf5f1173ba.png](https://ituknown.cn/java-media/i18n/set-locale-a04a0edf5f1173ba.png)

另外，Locale 类中内置了许多方言实例（如下图），这些方言实例基本上就够我们使用了。如果业务太广不够用也可以自己构造 Locale 实例~

![locale-4d306b99fe9d1faf.png](https://ituknown.cn/java-media/i18n/locale-4d306b99fe9d1faf.png)
...
![create-resource-bundle-file-ecbeaca92756e0a7.png](https://ituknown.cn/java-media/i18n/create-resource-bundle-file-ecbeaca92756e0a7.png)

![resource-bundle-add-lang-869faf8570425d43.png](https://ituknown.cn/java-media/i18n/resource-bundle-add-lang-869faf8570425d43.png)

之后就会在 i18n 目录下出现三个语言包文件：

![i18n-dir-QnSyO0vvMH4.png](https://ituknown.cn/java-media/i18n/i18n-dir-QnSyO0vvMH4.png)

这里我默认将 LanguageBundle 文件设置简体中文语言包，en_US 为英语语言包，zh_TW 设置为繁体中文语言包。

现在就添加语言配置：

![i18n-add-item-0y5N5zw.png](https://ituknown.cn/java-media/i18n/i18n-add-item-0y5N5zw.png)
...
![chinese-encoding-TgqYFjnY8aw.png](https://ituknown.cn/java-media/i18n/chinese-encoding-TgqYFjnY8aw.png)
...
![fix-chinese-encoding-b1t3HCAnX9I.png](https://ituknown.cn/java-media/i18n/fix-chinese-encoding-b1t3HCAnX9I.png)
...
![SpringMessageSourceControl-OBXKunD2ZXc.png](https://ituknown.cn/java-media/i18n/SpringMessageSourceControl-OBXKunD2ZXc.png)

我们直接看他的流式如何处理的：

![SpringMessageSourceControlDefaultEncoding-5GuStCWPCX0.png](https://ituknown.cn/java-media/i18n/SpringMessageSourceControlDefaultEncoding-5GuStCWPCX0.png)
